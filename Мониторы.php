...
<div class="slideshow-container">
    <div class="slide active">
            <img src="123321321.png" alt="Slide 1">
            <div class="text-overlay">МОНИТОРЫ НА ЛЮБОЙ ВКУС</div>
            <div class="text-overlay2">
                <br>Иммерсивные мониторы, обеспечивающие захватывающий игровой опыт благодаря высокому разрешению, быстрой частоте обновления и широким углам обзора. 
                Идеальный выбор для геймеров, ценящих яркие и насыщенные цвета, плавные переходы и реалистичное изображение в каждой игре. 
                <br></div>
            </div>
        </div>
