...
<div class="slideshow-container">
        <div class="slide active">
            <img src="notebook_woodo.jpg" alt="Slide 1">
            <div class="text-overlay">НОУТБУКИ ДЛЯ ГЕЙМИНГА</div>
            <div class="text-overlay2">
                <br>Мощные модели игровых ноутбуков, оснащенные передовыми технологиями NVIDIA и высокоэффективными процессорами 
                Intel Core 13-го поколения. Отличный выбор для тех, кому важно сочетание мобильности и производительности в одном устройстве. 
                <br></div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="product-card-container">
            <div class="product-card">
                <img src="213122132132113213213.png" alt="Product 1">
                <h3>Игровой ноутбук GIGABYTE</h3>
                <p></p>
                <span class="price">0 ₽</span>
                <a href="" class="btn">В корзину</a>
            </div>
                <div class="product-card">
                    <img src="asus-rog-strix-g16.jpg" alt="Product 1">
                    <h3>Игровой ноутбук ASUS</h3>
                    <p></p>
                    <span class="price">0 ₽</span>
                    <a href="" class="btn">В корзину</a>
                </div>
                ...
                <div class="product-card">
                    <img src="msi-raider-ge78-hx-13v.jpg" alt="Product 1">
                    <h3>Игровой ноутбук MSI</h3>
                    <p></p>
                    <span class="price">0 ₽</span>
                    <a href="" class="btn">В корзину</a>
                </div>              
